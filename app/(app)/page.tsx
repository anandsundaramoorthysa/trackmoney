  ...
  try {
    ...
    return (
      <div className="space-y-6">
        ...
        <Link
          href="/assistant"
          className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-agent/40 bg-agent-tint px-4 py-3.5 transition-colors hover:border-agent"
        >
          <span className="min-w-0">
            ...
            <span className="mt-1 block max-w-xl text-sm text-muted">
              ...
              approve. It never takes a payment on its own.
            </span>
          </span>
